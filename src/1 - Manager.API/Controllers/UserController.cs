    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(long id)
        {
            try
            {
                ...
                if (user == null)
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhum usuário foi encontrado com o ID infomado.",
                        Success = true,
                        Data = user
                    });
                return Ok(new ResultViewModel
                {
                    Message = "Usuário entrocado com sucesso!",
                    Success = true,
                    Data = user
                });
            }
        ...
        public async Task<IActionResult> GetByEmail([FromQuery] string email)
        {
            try{
                ...
                return Ok(new ResultViewModel
                {
                    Message = "Nenhum usuário foi encontrado com email informado.",
                    Success = true,
                    Data = user
                });
                ...
                return Ok(new ResultViewModel
                {
                    Message = "Usuaário encontrado com sucesso!",
                    Success = true,
                    Data = user
                });
            }
